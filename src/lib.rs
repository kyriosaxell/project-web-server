...
/// Send se usa para poder ser transferido entre los límites de hilos
...
impl ThreadPool {
    ...
    pub fn new(size: usize) -> ThreadPool {
        ...
        // Toda la data que se envíe de Sender estará disponible para Receiver en el mismo orden
        // que fueron enviados.
